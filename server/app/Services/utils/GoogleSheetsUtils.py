...
class GoogleSheetsUtils:
    ...
    def open_worksheet(self):
        ...
        return sh.worksheet("departamentos")

    def get_last_id_from_google(self):
        hoja = self.open_worksheet()
    ...
    def obtener_indice_fila_por_id(self, id_buscar):
        hoja = self.open_worksheet()
        columna_id = hoja.col_values(1)  # Suponiendo que ID está en la primera columna (columna 1)
    ...
    def obtener_indice_columna(self, nombre_columna):
        hoja = self.open_worksheet()
